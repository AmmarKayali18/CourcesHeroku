        ...
        <div class="card-body">
            ...
            <div class="general-button">
                <button type="button" data-toggle="modal" data-target="#addAdmin"
                    class="btn mb-1 btn-flat btn-info">@lang('trans.add_new_teacher')</button>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><img src="{{$teacher->image_path}}" style="height: 50px; width: 50px;"
                                            class=" rounded-circle mr-3" alt="">{{$teacher->name}}</td>
                                    <td>{{$teacher->email}}</td>
                                    <td>{{$teacher->mobile}}</td>
                                    <td>{{$teacher->address}}</td>
                                    <td><button type="button" onclick="update({{$teacher->id}})"
