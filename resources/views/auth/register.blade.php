            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 col-md-7">
                    <div class="card custom-form border-0 " style="border-radius: 10px">
                        <!-- <div class="card-body"> -->
                        <form class="rounded shadow p-4" enctype="multipart/form-data" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group position-relative">
                                        ...
                                        <input name="name_ar" style="direction:rtl" id="name_ar" type="text"
                                            class="form-control pl-5" placeholder="@lang('trans.full_name_ar_hint')">
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-md-6">
                                    <div class="form-group position-relative">
                                        ...
                                        <i data-feather="user" class="fea icon-sm icons"></i>
                                        <input name="name_en" id="name_en" type="text" class="form-control pl-5"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group position-relative">
                                        ...
                                        <input name="mobile" id="mobile" type="number" class="form-control pl-5"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group position-relative">
                                        ...
                                        <input name="address" id="address" class="form-control pl-5"
                                ...
                                <div class="col-sm-12">
                                    <input type="submit" id="submit" name="send" class="submitBnt btn btn-primary"
                                        value="@lang('trans.register')">
                                    @lang('trans.have_account') <a class="" href="{{ route('login')}}">
                                        @lang('trans.login')</a>
                                </div>
                                <!--end col-->
                            </div>
